...
HEARTS=("♥" "♡" "<3" "Ɛ>" "LOVE" "ǝʌoן" "Enjoy Coding" "Have a nice day" "Miss you" "Buntu coding" "Butuh Ide" "Animasi" "Linux User"  "Coding gak jelas" "Coding ngasal")
...
sigint() {
	local x, y
	end_text=" Ɛ> Have a nice day guys! <3 "
